...
export function DirectAIClient() {
  ...
  const runDirectAITest = useCallback(async () => {
    ...
    console.log('🚀 DIRECT AI CLIENT TEST - Bypassing AI SDK dependencies');
    ...
    try {
      ...
      addResult({
        ...
        status: 'info',
        message: 'Testing direct API authentication with nano-banana model...'
      });
      ...
      const authResponse = await fetch('https://api.youware.com/public/v1/ai/images/generations', {
        ...
        headers: {
          ...
          'User-Agent': 'DirectAI-Client/1.0'
        },
        body: JSON.stringify({
          model: 'nano-banana',
